  ...
  return (
    <>
      <button onClick={onClick}
        ...
        type="submit"
        className={`${(btnType === "primary") ? ` cursor-pointer w-full bg-blue-900 rounded-xl border border-red-900 py-3 px-10 flex items-center justify-center  font-normal text-white transform transition duration-300  hover:bg-white hover:text-blue-900 hover:border-1 hover:border-blue-900` : ""} ${(btnType === "secondary") ? ` cursor-pointer w-full bg-red-900 rounded-xl border border-red-900 py-3 px-10 flex items-center justify-center font-normal text-white transform transition duration-300  hover:bg-white hover:text-blue-900 hover:border-1 hover:border-blue-900` : ""} ${(btnSize === "sm") ? `text-sm` : ""} ${(btnType === "nude") ? `cursor-pointer w-full bg-white rounded-xl border border-white py-3 px-10 flex items-center justify-center font-normal text-white transform transition duration-300  hover:bg-blue-900 hover:text-blue-900 hover:border-1 hover:border-red-800` : ""} ${(btnType === "tertiary") ? `cursor-pointer w-full bg-red-800 rounded-xl border border-red-900 py-3 px-10 flex items-center justify-center font-normal text-white transform transition duration-300  hover:bg-red-900 hover:text-blue-900 hover:border-1 hover:border-red-800` : ""} `} >
        {loading ?
